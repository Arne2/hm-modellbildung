...
Load[type_] := Module[{data},
	data = SemanticImport[FileNameJoin@{NotebookDirectory[],"../data/data1_Phone_ 1000", type <> ".csv"},HeaderLines->1];
...
dataQueuePath = FileNameJoin@{NotebookDirectory[],"../data/data1_Phone_ 1000/queue.csv"};
...
d = Import[FileNameJoin@{NotebookDirectory[],"../data/data1_Phone_ 1000", "queue" <> ".csv"},HeaderLines->1];
