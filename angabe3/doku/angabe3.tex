...
\begin{figure}[!htb]
	...
	\begin{minipage}{.5\textwidth}
		...
		\caption{Evakuierung eines Raumes mit 2 Türen, Fast-Marching Algorithmus (Ende der Evakuierung)}
		\label{fig:Eva2TEndeFM}
	\end{minipage}%
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\textwidth]{abbildungen/Evak4TuerenEndeFM.png}
		\caption{Evakuierung eines Raumes mit 4 Türen, Fast-Marching Algorithmus (Ende der Evakuierung)}
