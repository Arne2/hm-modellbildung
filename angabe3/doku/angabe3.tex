...
Mit Hilfe der verschiedenen Evakuierungstests sollen die Auswirkungen unterschiedlicher Positionen und Anzahl von Türen auf die Dauer der Evakuierung eines Raumes ermittelt werden. Die Berechnung des Zielnutzens auf Basis des Euklid Algorithmus wird hierbei nicht berücksichtigt.  
%TODO Begründung
...
Da das in Abschnitt \ref{EvaVerifikation} beschriebene Szenario zwar für die Verifikation relevant ist, doch in der Realität äußerst unwahrscheinlich ist, werden in diesem Abschnitt weitere Evakuierungstests gegenübergestellt. \\
