...
Wie bereits im Abschnitt \ref{Anf:Personen} kurz erläutert, wird die Entscheidung, welche Zelle eine Person als nächstes betritt abhängig vom verwendeten Algorithmus und von den Positionen der anderen Personen getroffen. In der Realität fühlen sich Personen unwohl, wenn sie anderen, insbesondere fremden Personen zu nahe kommen. Personen versuchen somit eine solche Situation wenn möglich zu vermeiden. Beispielsweise bei der Fahrt in einem überfüllten Aufzug lässt sich diese Situation nicht vermeiden, doch jede Person ist froh wenn sie ihr Stockwerk erreicht und die Situation vorbei ist. In der Ebene sind solche Situationen jedoch häufig vermeidbar. Personen neigen in der Realität dazu einen Umweg in kauf zu nehmen, um einem Gedränge zu entkommen. Um dieses Verhalten in der Simulation zu berücksichtigen existieren verschiedene mathematische Funktionen. Mit Hilfe der Funktionen wird das Abstoßungspotenzial ermittelt. Während auf der einen Seite der Nutzen einer Person steigt, je näher sie dem Ziel kommt, verringert sich dieser Nutzen auf der anderen Seite wieder, wenn sie anderen Personen zu nahe kommen. Mit Hilfe von Funktionen kann somit der Nutzenverlust einer Person bestimmt werden. \\
%TODO: Warum glatte Fkt auf kompakten Trägern verwenden?
Insbesondere glatte Funktionen auf kompakten Trägern eignen sich hierfür gut. Hintergrund hierfür ist die Eigenschaft solcher Funktionen, außerhalb eines begrenzten Gebietes komplett zu verschwinden. Wäre dies nicht der Fall, würde eine sehr weit entfernte Person die Entscheidung einer anderen Person beeinflussen. Dies entspricht nicht der Realität. Das Abstoßungspotenzial von Personen ist auf einen Bereich beschränkt. \\
