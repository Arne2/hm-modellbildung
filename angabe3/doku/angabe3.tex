...
Insbesondere glatte Funktionen auf kompakten Trägern, welche außerhalb eines begrenzten Gebietes komplett zu verschwinden eignen sich hierfür gut. Würde der Wert der Funktion auch außerhalb des begrenzten Bereiches größer als $0$ sein, würde dies eine Abweichung von der Realität bewirken, da dadurch im Modell eine Person auch durch eine sehr weit entfernte Person, wenn auch nur leicht, beeinflusst werden würde. Dies widerspricht der Realität, da das Abstoßungspotenzial von Personen auf einen Bereich um die entsprechende Person beschränkt ist. \\
